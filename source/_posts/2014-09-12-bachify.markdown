...
aesthetic choices, and that's why I included the [unabridged 1-249
playlist][BWV 1-249 unabridged] as well.
...
you'd hear all the cantatas first, then all the motets and masses, then all the
chorales in alphabetical order... and you'd get to the best-known instrumental
pieces many days later. It wouldn't be a good mix.
...
* A number of chorales in BWV 250-438 correspond to organ arrangements in BWV
  ...
  track.
* Some pieces exist that *aren't* in the BWV list. One ensemble that I included
  in the playlist has recorded a canon that they believe goes between BWV 1077
  and BWV 1078. That canon is in the list, labeled "BWV deest", which is Latin
  for basically "BWV is missing".
